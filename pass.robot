...
<object class="Robot" serializationversion="2">
  <prologue>
    ...
    <referenced-snippets/>
    <typed-variables>
      <typed-variable name="pwd" type-name="pass"/>
    </typed-variables>
    <parameters/>
    <return-variables/>
  ...
  <property name="variables" class="Variables">
    <object class="Variable" serializationversion="1">
      <property name="name" class="String">pwd</property>
      <property name="initialAssignment" class="InitialVariableAssignment">
        <property name="type" class="TypeReference" serializationversion="0">
          <property name="typeName" class="String">pass</property>
        </property>
      </property>
    </object>
  </property>
      ...
      <object class="Transition" serializationversion="3" id="3">
        ...
        <property name="stepAction" class="WriteFile" serializationversion="0">
          <property name="fileNameExpression" class="kapow.robot.plugin.common.support.expression.stringexpr.ValueStringExpression">
            <property name="value" class="String">C:/Test/pass_schedule.txt</property>
          </property>
          <property name="fileContentExpression" class="kapow.robot.plugin.common.support.expression.multipletype.VariableExpression" serializationversion="2">
            <property name="variable" class="kapow.robot.plugin.common.support.AttributeName2">
              <property name="name" class="String">pwd.test</property>
            </property>
          </property>
        </property>
